 ...
 * FutaNeko向けに変更
 * 変更日: 2026-08-31
 * 変更詳細: 対応する同梱patch: mpv-0.41.0-shared-audio-session.patch
 * 上流の著作権/ライセンス保持
 * 対象: audio/out/ao_audiounit.m
 * ========================================================================
 */
