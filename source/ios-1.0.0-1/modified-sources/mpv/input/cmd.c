 ...
 * FutaNeko向けに変更
 * 変更日: 2026-08-31
 * 変更詳細: 対応する同梱patch: mpv-0.41.0-local-only.patch
 * 上流の著作権/ライセンス保持
 * 対象: input/cmd.c
 * ========================================================================
 */
